...
class NotificationsController extends Controller
{
    ...
    public function whatsappBotMessage() {
        ...
        $msg = join("\n\n", [
            "👋 Коллеги, привет! Это напоминалка перед сменой.",
            "Перед началом работы:",
            "- Проверьте, что ваш WhatsApp-бот работает.",
            "- Убедитесь, что все диалоги с клиентами завершены или отвечены.",
            "- В течение дня следите, чтобы бот не отключался и всё шло стабильно.",
            "Спасибо вам и хороших касс! 💸",
            "🟢 Отпишитесь в комментарии или поставьте реакцию, чтобы было видно, что вы прочитали это сообщение.",
        ]);
