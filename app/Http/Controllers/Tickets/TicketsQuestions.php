...
class TicketsQuestions
{
    public const templates = [
		...
		"topplus" => [
			...
			"category_id" => 1,
				"questions" => [
					...
					[
						"text"  => "Сколько работает в BRITVA на позиции ТОП-БАРБЕР?",
					],
					[
						"text"  => "Укажите статистику по клиентской базе из Yclients за последние 3 месяца по сотруднику",
					],
		...
		"blacklist" => [	
			...
			"questions" => [
				[
					"text" => "ФИО сотрудника. Укажите полные имя и фамилию сотрудника. *",
				],
				[
					"text" => "Контактный номер телефона. Укажите действующий номер телефона сотрудника (если имеется).",
					"rules" => [],
				],
				[
					"text"  => "Период работы в филиале. Сколько времени сотрудник проработал в вашем филиале? Укажите в днях, неделях или месяцах. *",
				],
				[
					"text"  => "Описание причины включения в черный список. Подробно опишите ситуацию, послужившую основанием для включения сотрудника в черный список. Приведите конкретные факты и обстоятельства.",
					"rules" => [],
				],
				[
					"text"  => "Подтверждающие материалы. Прикрепите доказательства: скриншоты, видеозаписи, переписки и иные файлы, подтверждающие нарушение.",
					"rules" => [],
				],
				[
					"text"  => "Фотография сотрудника. Добавьте ссылку на фотографию сотрудника или прикрепите файл ниже.",
					"rules" => [],
				]
			],
		],
