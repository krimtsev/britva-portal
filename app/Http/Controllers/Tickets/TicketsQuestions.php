    ...
    public const templates = [
		...
		"topnail" => [
			...
			"questions" => [
				...
				[
					"text"  => "Выполняет полный перечень услуг? Если нет, на какие услуги закрыта запись?",
				],
				[
					"text"  => "Укажите статистику по клиентской базе из Yclients за последние 3 месяца по сотруднику",
				],
		...
		"podolog" => [
			...
			"questions" => [
				...
				[
					"text" => "Общий стаж работы мастером",
				],
				[
					"text"  => "Есть ли сертификаты о прохождении подологических курсов?",
				],
				[
					"text"  => "Была ли практика подологических услуг?",
				],
				[
					"text"  => "Есть ли вытяжки 4blanc в филиале?",
				],
				[
					"text"  => "Какие кресла представлены на педикюре? Реклайнеры или мягкие кресла?",
				],
				[
					"text"  => "Если хотите оставить комментарий по сотруднику, укажите его здесь",
					"rules" => [],
		...
		"blacklist" => [
			...
			"description" => [
				...
				"5. Махинации и сговор сотрудников салона красоты против интересов работодателя.",
				...
				"8. Присвоение денежных средств клиентов SODA.",
