    ...
    function getRecordsByStaffId($staff_id) {
        try {
            ...
            $FILTER_IDS = [
                ...
                11414143, // ХИМИЧЕСКАЯ ЗАВИВКА ДО 15 СМ
                11414144, // ХИМИЧЕСКАЯ ЗАВИВКА ДО 25 СМ
                11414177, // МЕЛИРОВАНИЕ ОДНОЙ ПРЯДИ
                11414178, // МЕЛИРОВАНИЕ ПРИКОРНЕВОЕ
                11414179, // ОКРАШИВАНИЕ КОРОТКОЙ ДЛИНЫ (ДО 3 СМ)
                11414181, // ОКРАШИВАНИЕ СРЕДНЕЙ ДЛИНЫ (ДО 7 СМ)
                11414183, // ОКРАШИВАНИЕ СРЕДНЕЙ ДЛИНЫ (ОТ 7 СМ)
                11414185, // ТОНИРОВАНИЕ УЖЕ ОБЕСЦВЕЧЕННОЙ БАЗЫ
                11414184, // ОСВЕТЛЕНИЕ КОРНЕЙ
                11414218, // BLACK MASK
                11414222, // VOLCANO
