    ...
    function getRecordsByStaffId($staff_id) {
        try {
            ...
            $FILTER_IDS = [
                ...
                11702784, // ЛЕЧЕБНОЕ ПОКРЫТИЕ BANDI/STRADERM (РУКИ)
                11702808, // ЛЕЧЕБНОЕ ПОКРЫТИЕ BANDI/STRADERM (РУКИ) // ТОП-МАСТЕР
                13509653, // ЛЕЧЕБНОЕ ПОКРЫТИЕ BANDI/STRADERM (РУКИ) // БРЕНД-МАСТЕР
                17196566, // ЛЕЧЕБНОЕ ПОКРЫТИЕ BANDI/STRADERM (НОГИ)
                17196605, // ЛЕЧЕБНОЕ ПОКРЫТИЕ BANDI/STRADERM (НОГИ) // ТОП-МАСТЕР
                17196629, // ЛЕЧЕБНОЕ ПОКРЫТИЕ BANDI/STRADERM (НОГИ) // БРЕНД-МАСТЕР
                ...
                11725506, // ФРЕНЧ
                17194035, // ФРЕНЧ // ТОП-МАСТЕР
                17194036, // ФРЕНЧ // БРЕНД-МАСТЕР

                // БРОВИСТЫ

                11702825, // СЧАСТЬЕ ДЛЯ БРОВЕЙ
                13510355, // СЧАСТЬЕ ДЛЯ БРОВЕЙ (BOTOX) // ТОП-МАСТЕР
                17528729, // СЧАСТЬЕ ДЛЯ БРОВЕЙ (BOTOX) // БРЕНД-МАСТЕР
                ...
                11703088, // УКЛАДКА (КОРОТКИЕ) // ТОП-СТИЛИСТ
                11703421, // УКЛАДКА (КОРОТКИЕ) // АРТ-СТИЛИСТ
                11703062, // УКЛАДКА (СРЕДНИЕ)
                11703083, // УКЛАДКА (СРЕДНИЕ) // ТОП-СТИЛИСТ
                11703418, // УКЛАДКА (СРЕДНИЕ) // АРТ-СТИЛИСТ
                11703064, // УКЛАДКА (ДЛИННЫЕ)
                11703085, // УКЛАДКА (ДЛИННЫЕ) // ТОП-СТИЛИСТ
                11703425, // УКЛАДКА (ДЛИННЫЕ) // АРТ-СТИЛИСТ
                15596964, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (КОРОТКИЕ)
                15597506, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (КОРОТКИЕ) // ТОП-СТИЛИСТ
                15597823, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (КОРОТКИЕ) // АРТ-СТИЛИСТ
                15596968, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (СРЕДНИЕ)
                15597507, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (СРЕДНИЕ) // ТОП-СТИЛИСТ
                15597825, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (СРЕДНИЕ) // АРТ-СТИЛИСТ
                15596963, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (ДЛИННЫЕ)
                15597504, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (ДЛИННЫЕ) // ТОП-СТИЛИСТ
                15597822, // УКЛАДКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (ДЛИННЫЕ) // АРТ-СТИЛИСТ
                19096889, // TOKIO INKARAMI ГЛУБОКОЕ ВОССТАНОВЛЕНИЕ ВОЛОС (КОРОТКИЕ)
                19096892, // TOKIO INKARAMI ГЛУБОКОЕ ВОССТАНОВЛЕНИЕ ВОЛОС (СРЕДНИЕ)
                19096992, // TOKIO INKARAMI ГЛУБОКОЕ ВОССТАНОВЛЕНИЕ ВОЛОС (ДЛИННЫЕ)
                19096995, // TOKIO INKARAMI ГЛУБОКОЕ ВОССТАНОВЛЕНИЕ ВОЛОС (ОЧЕНЬ ДЛИННЫЕ)
            ...
            $SERVICES_COST = [
                ...
                14957284 => 4500, // СТРИЖКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (СРЕДНИЕ) // АРТ-СТИЛИСТ
                14957285 => 6600, // СТРИЖКА + КЕРАТИНОВОЕ ЧУДО ОТ DAVINES (ДЛИННЫЕ) // АРТ-СТИЛИСТ
                14957260 => 2500, // СТРИЖКА + ЭКСПРЕСС-УХОД ВЕГЕТАРИАНСКОЕ ЧУДО ОТ DAVINES (КОРОТКИЕ) // АРТ-СТИЛИСТ
                14957261 => 3300, // СТРИЖКА + ЭКСПРЕСС-УХОД ВЕГЕТАРИАНСКОЕ ЧУДО ОТ DAVINES (СРЕДНИЕ) // АРТ-СТИЛИСТ
                14957263 => 3700, // СТРИЖКА + ЭКСПРЕСС-УХОД ВЕГЕТАРИАНСКОЕ ЧУДО ОТ DAVINES (ДЛИННЫЕ) // АРТ-СТИЛИСТ

                17542812 => 1500, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (КОРОТКИЕ)
                17542814 => 2000, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (СРЕДНИЕ)
                17542815 => 2700, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (ДЛИННЫЕ)
                17543018 => 2000, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (КОРОТКИЕ) // ТОП-СТИЛИСТ
                17543020 => 2300, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (СРЕДНИЕ) // ТОП-СТИЛИСТ
                17543021 => 3200, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (ДЛИННЫЕ) // ТОП-СТИЛИСТ
                17543411 => 2400, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (КОРОТКИЕ) // АРТ-СТИЛИСТ
                17543412 => 2700, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (СРЕДНИЕ) // АРТ-СТИЛИСТ
                17543417 => 3800, // СТРИЖКА + ЭКСПРЕСС-УКЛАДКА (ДЛИННЫЕ) // АРТ-СТИЛИСТ
            ];
